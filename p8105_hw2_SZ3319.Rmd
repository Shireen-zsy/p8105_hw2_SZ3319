...
### 1.1 Import the `Mr. Trash Wheel` sheet and clean names
...
tail(mr_clean, 10)
```
### 1.2 Import the `Professor Trash Wheel` sheet and clean names
...
### 1.3 Import the `Gwynnda Trash Wheel` sheet and clean names
